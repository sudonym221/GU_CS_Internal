...
$current_status=addslashes($_POST['current_status']);
  ...
  if(!isset($error)){
    ...
    try {
      ...
      $sql="INSERT INTO  (sid,rollno,fname,mname,lname,city,state,country,address,pin,landline,mobile,email,bloodgroup,gurdain_name,gurdain_contact,session,doa,photo,course_id,caurent_status) VALUES ('$sid','$rollno','$fname','$mname','$lname','$city','$state','$country','$address','$pin','$landline','$mobile','$email','$bloodgroup','$gurdain_name','$gurdain_contact','$session','$doa,','$hoto','$course_id','$caurent_status')";
      
      if (mysql_query($sql, $conn)) {
      ?>
      <div class="alert alert-success alert-dismissible" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <strong>Success!</strong>  New Student Inserted.
</div>
...
<!-- Form Name -->
<h2 align="center"> Add Student Information</h2>
