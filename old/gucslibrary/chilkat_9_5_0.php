...
class CkMailMan {
	...
	function SendMimeQ($from,$recipients,$mimeText) {
		return CkMailMan_SendMimeQ($this->_cPtr,$from,$recipients,$mimeText);
	}
...
class CkZip {
	...
	function SetExeConfigParam($name,$value) {
		CkZip_SetExeConfigParam($this->_cPtr,$name,$value);
	}
