 ...
 $book_type=addslashes($_POST['book_type']);
  ...
  if(!isset($error)){
    ...
    try {
      ...
      $sql="UPDATE books_info book_id='$book_id',accession_no='$accession_no', title='$title' ,book_cat_id='$book_cat_id' , isbn_10='$isbn_10' ,isbn_13='$isbn_13',authors='$authors', edition='$edition', yopub='$yopub', total_pages='$total_pages',  price='$price',pub_code='$pub_code', shelf_no='$shelf_no', attachments='$attachments', entry_emp_id='$entry_emp_id', book_status='$book_status', book_type='$book_type' WHERE accession_no = '$accession_no'";
...
<!-- Form Name -->
<h2 align="center"> Update Book Information </h2>
...
<div class="form-group">
 ...
 <div class="col-md-4">
    <div class="input-group">
     <input id="accession_no" name="accession_no" type="text" placeholder="Accesion No" class="form-control input-md" required="">
       <div class="input-group-btn">
        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
          Select
          <span class="caret"></span>
        </button>
        <ul id="aclistacc" class="dropdown-menu pull-right">
                              <?php
$sql="SELECT * FROM books_info";
$result=mysql_query($sql);
while($row=mysql_fetch_array($result)) {      
              echo "<li><a >".$row['accession_no']."</a></li>";
            }?>
        </ul>
 <script type="text/javascript">
 $("#aclistacc").parent().find("a").on('click', function() {
            var option= $(this).text();
      $("#accession_no").val(option);
      var myurl = "http://localhost/gucslibrary/getBookDetails.php?accession_no="+option;
     // alert(myurl);    
      $.ajax({
      url: myurl,
          type: 'GET',   
      ...
      success: function(data) {
          $("#accession_no").val(data.accession_no);
           ...
           $("#shelf_no").val(data.shelf_no);  
           $("#attachments").val(data.attachments);
           $("#entry_emp_id").val(data.entry_emp_id);      
      }
   });
    });        
 </script>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="edition">Shelf No.</label>  
  <div class="col-md-4">
  <input id="shelf_no" name="shelf_no" type="text" placeholder="Shelf No." class="form-control input-md" required="">
