...
<div class="form-group">
  <label class="col-md-4 control-label" for="mid">Book Category ID</label>  
  <div class="col-md-4">
  <input id="mid" name="mid" type="text" placeholder="<?php
 $sql="SELECT AUTO_INCREMENT FROM information_schema.TABLES WHERE TABLE_SCHEMA = 'gucslib_db' AND TABLE_NAME = 'book_categories' ";
